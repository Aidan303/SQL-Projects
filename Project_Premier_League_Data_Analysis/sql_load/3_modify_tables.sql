/*
\copy prem.player_possession_stats FROM 'C:\Users\aidan\SQL Projects\csv_files\Prem CSV Files\player_possession_stats_cleaned.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy prem.player_salaries FROM 'C:\Users\aidan\SQL Projects\csv_files\Prem CSV Files\player_salaries_cleaned.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy prem.player_stats FROM 'C:\Users\aidan\SQL Projects\csv_files\Prem CSV Files\player_stats_cleaned.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
